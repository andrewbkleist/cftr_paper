# Description:
# Imports data from Bihler, et al., 2023, biorxiv and annotates, analyzes data
#
# NOTES
# (1) Manually annotated "bihler_2023.csv" file (bihler_2023_mod.csv) so that 
#  regex could extract residue numbers and also could distinguish multiple 
#  residue indels (not considered here) from single residue indels
#
# (2) Key values (after pivoting colnames, below):
#  - Baseline variant conductance = "fsk_pct_wt_DMSO"
#  - Baseline variant folding = "band_c_pct_wt_DMSO" (chosen empirically based
#    on ∆F508 values that would give less than 10% WT)
...
#
# ISSUES
# (1) How do I select CF-causing variants exclusively? 10% thresholds?
# (2) "band_c_pct_wt_DMSO" for ∆F508 is >10% except for the control version
